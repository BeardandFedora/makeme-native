...
//
// Otherwise, this  tries to find a MIME boundary at the beginning of the data block, and
...
- (void)logFetchWithError:(NSError *)error {
  ...
  //
  // we'll use a local variable since this  may be reentered while waiting for XML formatting
